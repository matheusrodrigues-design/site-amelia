            ...
            <div className="max-w-5xl mx-auto px-6 md:flex items-center gap-16">
                ...
                <div className="md:w-1/2 mb-10 md:mb-0">
                    ...
                    <p className="text-lg text-zinc-600 mb-8 leading-relaxed">
                        Um acompanhamento próximo e personalizado focado no seu momento profissional. Juntos(as), vamos identificar seus pontos fortes, superar desafios de liderança e traçar um plano de ação para você alcançar novos cargos e resultados.
                    </p>
