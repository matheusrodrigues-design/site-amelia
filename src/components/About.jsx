...
const About = () => {
  return (
    <section id="sobre" className="py-24 bg-white">
      {/* Mudamos para max-w-6xl e items-start (em vez de items-center) */}
      <div className="max-w-6xl mx-auto px-6 md:flex items-start gap-16">
        
        {/* LADO ESQUERDO: FOTO (Agora Sticky/Fixa ao rolar) */}
        {/* Usamos sticky top-32 para ela grudar na tela, abaixo do menu */}
        <div className="md:w-5/12 mb-10 md:mb-0 sticky top-32">
          {/* Mudamos para aspect-[3/4] para a foto ficar mais alta (formato retrato) */}
          <div className="aspect-[3/4] rounded-2xl bg-zinc-100 overflow-hidden shadow-xl">
            <img
        ...
        <div className="md:w-7/12">
          <h2 className="text-3xl font-bold text-zinc-900 mb-8">Sobre Mim</h2>
          
          <div className="text-zinc-600 leading-relaxed space-y-5">
            ...
            <p className="text-zinc-800 text-lg font-medium mt-8 border-l-4 border-yellow-500 pl-4 py-1">
            ...
            <p className="pt-4 font-semibold text-zinc-900">
