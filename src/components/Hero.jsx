  ...
  return (
    <section id="inicio" className="relative h-screen flex items-center justify-center bg-zinc-900">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <p className="text-xl md:text-2xl text-zinc-300 max-w-2xl mx-auto font-light mb-10">Desbloqueie seu potencial profissional e prepare-se para liderar. Mentorias e conteúdos práticos para quem busca crescimento, destaque e resultados reais no mercado de trabalho.</p>
